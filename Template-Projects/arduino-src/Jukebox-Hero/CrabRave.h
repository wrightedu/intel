...
void crabRave() {
    ...
    // lava chicken
    int melody[] = {
        NOTE_D5, 8, NOTE_AS5, 8, NOTE_G5, 8, NOTE_G5, 16, NOTE_D5, 8, NOTE_D5, 16, NOTE_A5, 8, NOTE_F5, 8, NOTE_F5, 16,
        NOTE_D5, 8, NOTE_D5, 16, NOTE_A5, 8, NOTE_F5, 8, NOTE_F5, 16, NOTE_C5, (16 / 3), NOTE_C5, 8, NOTE_E5, 8, NOTE_C5, 16, NOTE_E5, 16,
        NOTE_D5, 8, NOTE_AS5, 8, NOTE_G5, 8, NOTE_G5, 16, NOTE_D5, 8, NOTE_D5, 16, NOTE_A5, 8, NOTE_F5, 8, NOTE_F5, 16, NOTE_D5, 16
    };
